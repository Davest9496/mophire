...
export default function Testimonials({
  variant = "with-bg",
  backgroundImage = "/assets/pages/homepage/images/testimonials_bg.png",
                ...
                {testimonials.map((testimonial) => (
                  <div key={testimonial.id} className="w-full flex-shrink-0">
                    <div className="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3 lg:gap-8">
                      {/* Card 1 */}
                      <div className="flex min-h-[300px] flex-col items-center bg-white p-6 text-center shadow-xl sm:min-h-[350px] lg:p-8">
                        {/* Quote Icon */}
                        <div className="mb-4">
                          <Image
                        ...
                        {/* Content */}
                        <p className="mb-6 flex-1 text-sm text-gray-700 sm:text-base">
                          {testimonial.content}
                        </p>
                      ...
                      <div className="hidden min-h-[350px] flex-col items-center bg-white p-6 text-center shadow-xl md:flex lg:p-8">
                        <div className="mb-4">
                          <Image
                            src="/assets/pages/homepage/icons/quote.svg"
                            alt=""
                      ...
                      <div className="hidden min-h-[350px] flex-col items-center bg-white p-6 text-center shadow-xl lg:flex lg:p-8">
                        <div className="mb-4">
                          <Image
                            src="/assets/pages/homepage/icons/quote.svg"
                            alt=""
              ...
              {testimonials.map((_, index) => (
                <button
                  ...
                  className={`h-2 rounded-full transition-all ${
                    index === currentIndex
                      ? "w-8 bg-[#153C78]"
                      : "w-2 bg-[#153C78]/40 hover:bg-[#153C78]/60"
                  }`}
  ...
  return (
    <section className="relative flex w-full overflow-hidden lg:min-h-[600px]">
      ...
      <div className="relative w-full lg:w-2/3">
        ...
        {/* Content Overlay */}
        <div className="relative z-10 flex h-full min-h-[600px] flex-col px-4 py-16 sm:px-8 sm:py-12 lg:px-12 lg:py-16">
          {/* Header Section */}
                ...
                {testimonials.map((testimonial) => (
                  <div key={testimonial.id} className="w-full flex-shrink-0">
                    <div className="grid grid-cols-1 gap-4 md:grid-cols-2 md:gap-6 lg:gap-8">
                      {/* Card 1 */}
                      <div className="relative mx-auto flex w-full max-w-md flex-col items-center bg-white p-4 text-center shadow-xl min-h-[300px] sm:min-h-0 sm:p-6 md:mx-0 md:max-w-none lg:p-8">
                        {/* Quote Icon */}
                        ...
                        {/* Content */}
                        <p className="mb-4 flex-1 text-sm text-gray-700 sm:mb-6 sm:text-base">
                          {testimonial.content}
                        </p>
